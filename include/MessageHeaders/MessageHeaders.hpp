...
namespace MessageHeaders
{
    ...
    public:
        ...
        struct Header
        {
            ...
            Header(const HeaderName& newName, const HeaderValue& newValue);
        };
    ...
    public:
        ...
        /**
         * This method returns a collection of tokens extracted from the header
         * with the given name in the message.
         *
         * @param[in] headerName
         *      This is the name of the header whose tokens should be returned
         *
         * @return
         *      returns the sequence of tockens from the value of the given
         *      header name.
         *
         * @retval {}
         *      If there is no header with the given name in the message
         *      then just an empty collection is returned.
         */
        std::vector<HeaderValue> GetHeaderTokens(const HeaderName& headerName) const;
         ...
         *
         * @param[in] oneLine
         *      This specifies whether or not to combine values into on header line, separated by
         * colons.
         */
        void SetHeader(const HeaderName& name, const std::vector<HeaderValue>& values,
                       bool oneLine);
         ...
         *
         */
        void AddHeader(const HeaderName& name, const std::vector<HeaderValue>& values,
                       bool oneLine);
     ...
     */
    void PrintTo(const MessageHeaders::HeaderName& name, std::ostream* os);
     ...
     */
    void PrintTo(const MessageHeaders::State& validity, std::ostream* os);
}  // namespace MessageHeaders
